    ...
    public partial class Form1 : Form
    {
        ...
        private void btneditar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                MySqlCommand cmd = realizaconexaoBD.CreateCommand();
                cmd.CommandText = "UPDATE fabricante SET nomeFabricante = '" + textBox2.Text +
        ...
        private void dataGridView1_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            if (dataGridView1.Rows[e.RowIndex].Cells[e.ColumnIndex].Value != null)
            {
                ...
                textBox4.Text = dataGridView1.Rows[e.RowIndex].Cells["ColumnId"].FormattedValue.ToString(); 
            }
        }
        ...
        private void btndeletar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                MySqlCommand cmd = realizaconexaoBD.CreateCommand();
                cmd.CommandText = "DELETE FROM fabricante WHERE idFabricante = '" + textBox4.Text + "'";
                cmd.ExecuteNonQuery();
